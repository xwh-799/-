<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="$detail.categoryView.category1Id">{{ $detail.categoryView.category1Name }}</span>
        <span v-show="$detail.categoryView.category2Id">{{ $detail.categoryView.category2Name }}</span>
        <span v-show="$detail.categoryView.category3Id">{{ $detail.categoryView.category3Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
